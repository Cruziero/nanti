...
import { Plus, Sparkles, Sun, Inbox, Hourglass, FolderKanban, Users, Settings as Cog } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <aside className="fixed inset-y-0 left-0 hidden w-[248px] flex-col border-r border-sidebar-border bg-sidebar px-3 py-5 lg:flex">
        ...
        <Link
          to="/app/settings"
          className={cn(
            "mt-4 flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13.5px] font-medium transition-colors",
